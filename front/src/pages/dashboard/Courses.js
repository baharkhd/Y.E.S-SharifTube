    ...
    >
      ...
      <Grid columns={3} stackable style={{ padding: "20px" }}>
        {!courses.loading &&
          yourClasses.map(course => {
            let date = new Date(course.createdAt * 1000).toLocaleString(
              "en-US",
              {
                month: "long",
                year: "numeric",
            ...
            return (
              <Grid.Column key={course.id}>
                <Link to={"/course:" + course.id}>
                  <Card raised onClick={() => {}} style={{ width: "100vh" }}>
      ...
      <Grid columns={3} stackable style={{ padding: "20px" }}>
                ...
                <Link to={"/course:" + course.id}>
                  <Card raised onClick={() => {}} style={{ width: "100vh" }}>
                    <Card.Content style={{ overflow: "hidden" }}>
                      ...
                      <Card.Description style={courseDescriptionStyle}>
                        {course.summary}
                      </Card.Description>
                    </Card.Content>
                    <Card.Content extra style={courseContentExtraLStyle}>
        ...
        {!courses.loading && otherClasses.length === 0 && (
          <Container textAlign="center" style={{ marginTop: "40px" }}>
            <Header as="h2" style={{ color: "red" }}>
              You're not member of any class.
            </Header>
          </Container>
        )}
      </Grid>
